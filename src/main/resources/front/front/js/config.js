...
var centerMenu = [
    ...
    ,{
        name: '档案',
        url: '../dangan/list.html'
    }
    ,{
        name: '党课收藏',
        url: '../dangkeCollection/list.html'
    }
    ,{
        name: '党课报名',
        url: '../dangkeOrder/list.html'
    }
    ,{
        name: '签到信息',
        url: '../kaoqin/list.html'
    }
    ,{
        name: '谈心谈话',
        url: '../liuyan/list.html'
    }
    ,{
        name: '入党申请',
        url: '../shenqingYuyue/list.html'
    }
    ,{
        name: '提醒',
        url: '../tixing/list.html'
    }
    ,{
        name: '在线学习收藏',
        url: '../xuexiCollection/list.html'
    }
    ,{
        name: '作业提交',
...
// 已废弃,不用了
var adminurl =  "http://localhost:8080/dxsdwxxpt/admin/dist/index.html#/login";
